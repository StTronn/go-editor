...
func TestIntegrateInsert_InsertD(t *testing.T) {
	doc := &Document{
		Characters: []Character{
			{ID: "start", Visible: false, Value: "", IDPrevious: "", IDNext: "a"},
			{ID: "a", Visible: false, Value: "a", IDPrevious: "start", IDNext: "b"},
			{ID: "b", Visible: false, Value: "b", IDPrevious: "a", IDNext: "c"},
			{ID: "c", Visible: false, Value: "c", IDPrevious: "b", IDNext: "e"},
			{ID: "e", Visible: false, Value: "e", IDPrevious: "c", IDNext: "f"},
			{ID: "f", Visible: false, Value: "f", IDPrevious: "e", IDNext: "end"},
			{ID: "end", Visible: false, Value: "", IDPrevious: "f", IDNext: ""},
		},
	}

	newChar := Character{ID: "d", Visible: false, Value: "d", IDPrevious: "c", IDNext: "e"}
	charPrev := Character{ID: "a", Visible: false, Value: "a", IDPrevious: "start", IDNext: "b"}
	charNext := Character{ID: "f", Visible: false, Value: "f", IDPrevious: "e", IDNext: "end"}
	...
	wantDoc := &Document{
		Characters: []Character{
			...
			{ID: "a", Visible: false, Value: "a", IDPrevious: "start", IDNext: "b"},
			{ID: "b", Visible: false, Value: "b", IDPrevious: "a", IDNext: "c"},
			{ID: "c", Visible: false, Value: "c", IDPrevious: "b", IDNext: "d"},
			{ID: "d", Visible: false, Value: "d", IDPrevious: "c", IDNext: "e"},
			{ID: "e", Visible: false, Value: "e", IDPrevious: "d", IDNext: "f"},
			{ID: "f", Visible: false, Value: "f", IDPrevious: "e", IDNext: "end"},
			{ID: "end", Visible: false, Value: "", IDPrevious: "f", IDNext: ""},
		},
	}
